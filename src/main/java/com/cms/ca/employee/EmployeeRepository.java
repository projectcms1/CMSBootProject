...
public interface EmployeeRepository {
	...
	List<view_counsel_dto> getOneCounsel(@Param("aply_sn") int aply_sn, @Param("stts_cd") String stts_cd);
	...
	List<view_counsel_dto> getConnectedCounsel(@Param("aply_sn") int aply_sn, @Param("bfr_aply_sn") int bfr_aply_sn);
}